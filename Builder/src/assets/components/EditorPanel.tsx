...
const EditorPanel = ({
  ...
  return (
    <div className="absolute top-4 right-4 w-[340px] bg-white rounded-xl shadow-2xl border border-gray-200 p-5 z-50 animate-fade-in fade-in ">
      <div className="flex justify-between items-center mb-5">
        <h3 className="text-sm font-bold text-gray-800">Edit Element</h3>
        <button
          onClick={onClose}
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-1.5 text-sm text-gray-700 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500"
            />
          </div>
          <div>
            <label className="block text-xs font-medium text-gray-500 mb-1.5">
            ...
            <div className="flex items-center gap-2 border border-gray-300 rounded-md px-2 py-1.5 focus-within:ring-1 focus-within:ring-indigo-500 focus-within:border-indigo-500 bg-white">
              <input
                ...
                value={
                  ...
                  values.styles.backgroundColor.includes("rgba") ||
                  values.styles.backgroundColor.includes("oklch")
                    ? "#ffffff"
                    : values.styles.backgroundColor
                }
                onChange={(e) =>
          ...
          <div>
            ...
            <div className="flex items-center gap-2 border border-gray-300 rounded-md px-2 py-1.5 focus-within:ring-1 focus-within:ring-indigo-500 focus-within:border-indigo-500 bg-white">
              <input
                ...
                value={
                  !values.styles.color ||
                  values.styles.color.includes("oklch") ||
                  values.styles.color.includes("rgba")
                    ? "#000000"
                    : values.styles.color
                }
